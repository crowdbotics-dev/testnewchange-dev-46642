...
## Project Structure
    ...
    ├── testnewchange_dev_46642  # Django project configurations
...
1. Clone this repo and `cd testnewchange_dev_46642`
...
2. Clone this repo and `cd testnewchange_dev_46642`
